...
export default function App() {
    ...
    return (
      <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3">
            ...
            >
              <ModalContent>
                {(onClose) => (
                  <>
                    <ModalHeader className="flex flex-col gap-1">Agregar personal academico</ModalHeader>
                    <ModalBody>
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">Total {actividad.length} personal academico</span>
          <label className="flex items-center text-default-400 text-small">
            Personal academico por pagina:
            <select
  ...
  >
    ...
    <ModalContent>
      {(onClose) => ( 
        <>
          <ModalHeader className="flex flex-col gap-1">Actualizar personal academico</ModalHeader>
          <ModalBody>
          <div className="flex flex-wrap gap-8">
                <div className="w-full">
                    <Input

...
import { extraercampoAmplio, agregarcampoAmplio, editarcampoAmplio, eliminarcampoAmplio } from "../../api/contratacion";
...
export default function App() {
  ...
  const handleAgregar = React.useCallback(() => {
    ...
    agregarcampoAmplio(newActividad);
  ...
  const handleActualizar = React.useCallback(() => {
    ...
    editarcampoAmplio(idA, editedUser);
          ...
          <div className="flex gap-3">
            ...
            >
              <ModalContent>
                {(onClose) => (
                  <>
                    <ModalHeader className="flex flex-col gap-1">Agregar Campo Amplio</ModalHeader>
                    <ModalBody>
  ...
  >
    ...
    <ModalContent>
      {(onClose) => ( 
        <>
          <ModalHeader className="flex flex-col gap-1">Actualizar Campo Amplio</ModalHeader>
          <ModalBody>
          <div className="flex flex-wrap gap-8">
                <div className="w-full">
                    <Input
